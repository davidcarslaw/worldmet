...
#'
#' If you access these data using the `worldmet` package please
#' give full acknowledgement to NOAA ISD. Users should also take a
#' note of the usage restrictions.
#'
#' These data work well with the `openair` package that has been
#' developed to analyse air pollution data.
#'
#' @author David Carslaw
#'
#' @references For general information of the ISD see
#' <https://www.ncei.noaa.gov/products/land-based-station/integrated-surface-database> and the map here
...
##' @docType package
##'
##' @seealso See <https://github.com/davidcarslaw/openair> for
##' information on the related `openair` package.
##'
##'
NULL
